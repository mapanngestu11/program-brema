                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <a class="btn btn-primary block" href="<?php echo site_url() . 'Instansi/add'; ?>" style=" float: right;">Tambah Data</a>
                        </div>
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    <?php
                                    $no = 0;
                                    foreach ($instansi->result_array() as $row) :
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a class="btn btn-link btn-primary btn-lg" href="<?php echo base_url() . 'Instansi/edit/' . $kode_instansi; ?>"><span class="fa fa-edit"></span></a>
                    ...
                    <div class="modal fade" id="ModalHapus<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form class="form-horizontal" action="<?php echo base_url() . 'Instansi/delete' ?>" method="post">
