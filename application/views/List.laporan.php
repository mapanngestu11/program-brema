...
<head>
    ...
    <title>Data Laporan Tagihan</title>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Data Laporan Tagihan</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <form action="<?php echo base_url('Laporan/cek_tanggal') ?>" method="post">
