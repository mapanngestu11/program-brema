                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <!-- <a class="btn btn-primary block" href="<?php echo site_url() . 'Tagihan/add'; ?>" style=" float: right;">Tambah Data</a> -->
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a class="btn btn-link btn-primary btn-lg" href="<?php echo base_url() . 'Tagihan/edit/' . $id; ?>"><span class="fa fa-edit"></span></a>
